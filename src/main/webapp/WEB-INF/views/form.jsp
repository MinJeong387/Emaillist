...
<body>
	<div class="container">
		<h1 class="mt-5">메일링 리스트 가입 (Model 2)</h1>
		<p>
			메일링 리스트에 가입하시려면,<br /> 아래 항목을 기입하고 등록 버튼을 클릭하세요.
		</p>

		<form action="<%=request.getContextPath()%>/el" method="POST">
			<input type="hidden" name="a" value="insert" />
			<div class="form-group">
				<label for="ln">성</label> <input type="text" class="form-control"
					name="ln" value="">
			</div>
			<div class="form-group">
				<label for="fn">이름</label> <input type="text" class="form-control"
					name="fn" value="">
			</div>
			<div class="form-group">
